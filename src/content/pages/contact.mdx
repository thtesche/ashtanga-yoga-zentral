...
"@type": "ContactPage",
"name": "Contact – Ashtanga Yoga Zentral Berlin",
"url": "https://www.ashtangayogazentralberlin.com/contact/",
"mainEntity": {
  "@type": "YogaStudio",
  ...
  {`
    ...
    form.addEventListener("submit", async (e) => {
      ...
      try {
        ...
        if (data.success) {
          result.textContent = "Thank you for your message. It has been sent.";
          form.reset();
        } else {
