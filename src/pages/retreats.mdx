  ...
  <div class="container">
    ...
    <div class="retreat-card surface animate-fade-in-delay">
      ...
      <div class="retreat-content">
        <Image src={import.meta.env.BASE_URL + "images/img_1_elinore_retreat_mecklenburg.webp"} alt="Mecklenburg Retreat" class="retreat-img" width={400} height={180} loading="eager"/>
    ...
    <div class="retreat-card surface mt-4">
      ...
      <div class="retreat-content">
        <Image src={import.meta.env.BASE_URL + "images/img_2_yogaPulia_retreat_centre_images.webp"} alt="Yoga Puglia Retreat" class="retreat-img" width={400} height={180} loading="eager"/>
