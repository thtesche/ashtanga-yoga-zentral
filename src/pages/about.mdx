  ...
  <div class="container animate-fade-in-delay">
    <div class="surface about-content">
      <div class="content-block">
        <Image src={import.meta.env.BASE_URL + "images/img_0_elinore_burke_with_dogs-300x225.webp"} alt="Elinore Burke with dogs" class="about-image" width={300} height={225} loading="eager" />
