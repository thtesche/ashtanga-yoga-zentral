...
assert(
  enIndex.includes("Ashtanga Yoga Zentral"),
  "EN index contains site title",
);
assert(
  enIndex.includes("Morning Ashtanga Yoga"),
  "EN index has English description",
);
...
assert(
  ...
  "DE index contains site title",
);
assert(
  deIndex.includes("Standort"),
  'DE index has German footer label "Standort"',
);
...
assert(
  deRetreats.includes(href("/de/kontakt")) &&
    !deRetreats.includes(href("/contact")),
...
assert(
  enRetreats.includes(href("/contact")) &&
    !enRetreats.includes(href("/de/kontakt")),
...
const mdxFiles = fs
  .readdirSync(srcPages, { recursive: true })
